    ...
    <body class="bg-gray-200">
        ...
        <nav class="bg-gray-600 p-3 text-center">
            ...
            <a href="#" class="text-white px-4">BANTUAN</a>
        </nav>

        <main class="p-6">
            <section class="bg-white shadow-md p-6 rounded-lg mb-6">
                <h2 class="text-2xl font-semibold mb-4">Selamat Datang di STONE ISLAND store</h2>
                <p>Ini adalah halaman depan website kami. Jelajahi berbagai informasi menarik dan layanan yang kami tawarkan.</p>
                <img src="{{ asset('images/login.jpg') }}" alt="Produk 1" class="w-full mb-4 rounded">
            </section>

            <section class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-white shadow-md p-4 rounded-lg">
                    <h3 class="text-xl font-semibold mb-2">Toko kami</h3>
                    <p>Kami menyediakan layanan terbaik untuk Anda dengan kualitas yang terjamin.</p>
                    <img src="{{ asset('') }}" alt="Produk 1" class="w-full mb-4 rounded">
                </div>
                <div class="bg-white shadow-md p-4 rounded-lg">
