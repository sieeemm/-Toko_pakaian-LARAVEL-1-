...
<body class="bg-gray-200 min-h-screen flex flex-col">
  <header class="bg-gray-700 text-white p-4 text-center">
    <h1 class="text-3xl font-bold">PANTS STONE ISLAND</h1>
  </header>
  ...
  cursor: pointer;
    ...
    <main class="p-6 flex-1">
      <h2 class="text-2xl font-semibold mb-6 text-center">MY PANTS COLLECTION</h2>
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-white p-4 shadow-md rounded-lg">
          <img src="{{ asset('images/01.jpeg') }}" alt="Produk 1" class="w-full mb-4 rounded">
          <h3 class="text-xl font-bold mb-2">stone island corduroy pants </h3>
          <p class="font-semibold text-lg mb-2">Rp 250.000</p>
