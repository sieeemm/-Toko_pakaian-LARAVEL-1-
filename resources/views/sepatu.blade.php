...
<body class="bg-gray-200 min-h-screen flex flex-col">
  <header class="bg-gray-700 text-white p-4 text-center">
    <h1 class="text-3xl font-bold">SHOES STONE ISLAND</h1>
  </header>
  <nav class="bg-gray-600 p-3 text-center">
    <ul>
        ...
        <button><a href="sepatu"><li>SEPATU</li></a></button>
    </ul>
  ...
  cursor: pointer;
    ...
    <main class="p-6 flex-1">
      <h2 class="text-2xl font-semibold mb-6 text-center"> MY SHOES COOLECTION</h2>
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div class="bg-white p-4 shadow-md rounded-lg">
          <img src="{{ asset('images/11.jpeg') }}" alt="Produk 1" class="w-full mb-4 rounded">
          <h3 class="text-xl font-bold mb-2">NB 574 LEGACY STONE ISLAND</h3>
          <p class="font-semibold text-lg mb-2">Rp 4.500.000</p>
